...
custem    |slot      |-                      |-         |-         |'default' slot when custem-model is onwork
...
data|props|Function(page): Promise|-|required|axios required to get table data list and total
custem|slot|-|-|-|'default' slot when custem-model is onwork
mode|props|string|'table'|-|table type, can be 'table', 'tree' or 'custem'

# update
1.(new)custem-model table ---- 2020-07-07 20:59:36
2.doc update ---- 2020-08-12 19:20:58
