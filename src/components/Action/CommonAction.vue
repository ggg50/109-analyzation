...
extraButton|slot      |-         |-         |-         |-
itemList   |prop      |Array     |-         |-         |current items list, maybe is selected list
...
export default class extends Vue {
  ...
  @Prop({ default: true }) isDefaultShow!: boolean
  ...
  insertEditRawData() {
    if (!this.enableAction.edit || !this.itemList || this.itemList.length === 0) return
